...
```
  ...
  Rules help shape trading transactions at signal execution. This strategy has 2 rules:  
...
```
	...
	This strategy is profitable but it can be enhanced. 
...
## STRATEGY 2: DVO
  ...
  Instead of using the RSI_3_4 as the oscillator, let's use a custom DVO with navg = 2 and a percentlookback period of 126 that we call DVO_2_126 . 
